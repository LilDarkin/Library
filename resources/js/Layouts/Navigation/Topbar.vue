<template>
    <nav class="bg-white border-b border-gray-100 transition duration-300 ease-in-out">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div v-if="$page.props.user" class="flex items-center transition duration-300 ease-in-out">
                    <div>
                ...
                <div v-else class="transition duration-300 ease-in-out">
