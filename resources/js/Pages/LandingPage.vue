    ...
    <AppLayout>
        <div class="p-6">
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-4">
                        <div>
                            ...
                            <div class="text-sm font-medium text-gray-400">Books</div>
                        </div>
                    </div>
                    <a href="/books" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
                </div>
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1">100</div>
                            <div class="text-sm font-medium text-gray-400">Borrowed Books</div>
                        </div>
                    </div>
                    <a href="/borrowed-books" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
                </div>
            </div>
            <div v-show="$page.props.user.role === 0" class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        <div class="font-medium">Recent Borrower</div>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <a href="#"
                                                class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Student
                                                1</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b text-center border-b-gray-50">
                                        <span class="text-[13px] font-medium text-emerald-500">20241</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b text-center border-b-gray-50">
                                        <span class="text-[13px] font-medium text-rose-500">20242</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span
                                            class="inline-block p-1 rounded bg-rose-500/10 text-rose-500 font-medium text-[12px] leading-none">BORROWED</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
